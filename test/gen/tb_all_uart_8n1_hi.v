...
module tb;
  ...
  initial begin
    ...
    @(posedge clk); tx_csr_we = 1; tx_csr_addr = 6; tx_csr_wdata = 8'h02;
    @(posedge clk); tx_csr_addr = 7; tx_csr_wdata = 8'h08;
    @(posedge clk); tx_csr_addr = 8; tx_csr_wdata = 8'h00;
    @(posedge clk); tx_csr_we = 0;
    @(posedge clk); rx_csr_we = 1; rx_csr_addr = 6; rx_csr_wdata = 8'h01;
    @(posedge clk); rx_csr_addr = 7; rx_csr_wdata = 8'h0e;
